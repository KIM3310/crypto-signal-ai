...
class TestClassifySignal:
    def test_oversold_rsi_is_buy(self):
        tech = TechnicalResult(
            rsi=25.0, macd=0.1, macd_signal=0.05, macd_histogram=0.05, bb_percent=0.1
        )
    ...
    def test_overbought_rsi_is_sell(self):
        tech = TechnicalResult(
            rsi=80.0, macd=-0.1, macd_signal=0.05, macd_histogram=-0.15, bb_percent=0.9
        )
        signal, conf, _ = classify_signal(tech, None)
    ...
    def test_neutral_indicators(self):
        tech = TechnicalResult(
            rsi=50.0, macd=0.01, macd_signal=0.01, macd_histogram=0.0, bb_percent=0.5
        )
    ...
    def test_sentiment_boosts_buy(self):
        tech = TechnicalResult(
            rsi=35.0, macd=0.1, macd_signal=0.05, macd_histogram=0.05, bb_percent=0.3
        )
    ...
    def test_sentiment_boosts_sell(self):
        tech = TechnicalResult(
            rsi=65.0, macd=-0.1, macd_signal=0.05, macd_histogram=-0.15, bb_percent=0.85
        )
    ...
    def test_confidence_bounded(self):
        tech = TechnicalResult(
            rsi=10.0, macd=5.0, macd_signal=0.0, macd_histogram=5.0, bb_percent=-0.5
        )
